...
![basalt](https://repo.x-cmd.io/basalt.svg?lang=zh)
...
合计: **21,355** 行代码（覆盖前 5 种语言、共 **101** 个文件）。
...
- **Star**: 1,351 · **Fork**: 38 · **开放 issue**: 117 · **贡献者**: 9

## 累计统计

- **发布数**: 50 · **已合并 PR**: 510 · **开放 PR**: 1 · **已关闭 issue**: 78 · **开放 issue**: 39 · **提交数**: 1178
...
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/basalt.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260916.yml` · 2026-09-16T04:57:11Z._
